...
<div class="row g-3 mb-4">
    @php
    $cards = [
        ['label'=>'Commandes totales',   'value'=>$stats['total_orders'],           'icon'=>'fa-bag-shopping',    'color'=>'#c4786a','bg'=>'#fdf0ec'],
        ['label'=>'Revenus',        'value'=>'$'.number_format($stats['total_revenue'],2),'icon'=>'fa-coins','color'=>'#b89a72','bg'=>'#fdf8ef'],
        ['label'=>'Produits',       'value'=>$stats['total_products'],          'icon'=>'fa-shirt',           'color'=>'#6a8dc4','bg'=>'#eff3fd'],
        ['label'=>'Clients',      'value'=>$stats['total_users'],             'icon'=>'fa-users',           'color'=>'#6ac48a','bg'=>'#eff9f3'],
        ['label'=>'Commandes en attente', 'value'=>$stats['pending_orders'],          'icon'=>'fa-clock',           'color'=>'#c4a86a','bg'=>'#fdf8ef'],
        ['label'=>'Stock faible',      'value'=>$stats['low_stock'],               'icon'=>'fa-triangle-exclamation','color'=>'#c46a6a','bg'=>'#fdf0f0'],
    ];
    @endphp
        ...
        <div class="card border-0 shadow-sm" style="border-radius:6px">
            <div class="card-body p-0">
                <div class="d-flex align-items-center justify-content-between px-4 pt-4 pb-2">
                    ...
                    <a href="{{ route('admin.orders.index') }}" style="font-size:.82rem;color:#c4786a">Voir tout →</a>
                </div>
                <div class="table-responsive">
                    <table class="table mb-0">
                        <thead><tr>
                            <th>N° de commande</th><th>Client</th><th>Total</th><th>Statut</th><th></th>
                        </tr></thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{ route('admin.orders.show',$order) }}" style="color:#c4786a;font-size:.82rem">Voir</a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
    ...
    <div class="col-lg-4">
        <div class="card border-0 shadow-sm h-100" style="border-radius:6px">
            <div class="card-body px-4 pt-4">
                <h6 class="fw-semibold mb-3">Meilleurs produits</h6>
                ...
                <div class="d-flex align-items-center gap-2 mb-3">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div style="font-size:.75rem;color:#7a5c4e">{{ $p->order_items_count }} commandes</div>
                    </div>
